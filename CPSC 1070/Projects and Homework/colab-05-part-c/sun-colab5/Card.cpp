...
{
  return faceArray[static_cast<int>(face)] + " of " + suitArray[static_cast<int>(suit)];
}

/* getFace */
//Returns the enumerated type that the face of the card is
Faces Card::getFace()
{
  return face;
}
...
/* getSuit */
//Returns the enumerated type that the suit of the card is
Suits Card::getSuit()
{
  return suit;
}
