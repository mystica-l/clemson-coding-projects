 ...
 * Name: Kenny Sun
 * Date: 10/20/2023
 * Purpose: Source code for the Date class, creates Date objects that store a month, day, and year that all have overloaded operators
 * to perform actions like date++ to move forward dates
 */

#include <iostream> //Needed to print things out when invalid dates are made
#include "Date.h" //Needs own header file
#include "MysteryMachine.h" //Needed for the mystery machine class to use getDayOfWeek
...
/* toString */
//Returns the Date object as a string in the format of MM/DD/YYYY
